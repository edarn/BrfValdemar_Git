...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table align="center" width="97%">
        ...
        <tr>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Save" Width="64px" OnClick="Button1_Click1" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="GrdPreview" runat="server" AutoGenerateColumns="false" BorderWidth="0px"
                    RowStyle-BorderWidth="0px" BorderStyle="None" HeaderStyle-BorderWidth="0px" ShowHeader="false"
                    Width="100%" DataKeyNames="tid">
                    <Columns>
                        <asp:TemplateField ItemStyle-BorderWidth="0px">
                            <ItemTemplate>
                                ...
                                <br />
                                <table width="100%" style="border-top: 1px solid #ccc; border-left: 1px solid #ccc;
                                    ...
                                    background: url(images/shadow2.gif) no-repeat left top;">
                                    <tr>
                                        <td style="background-color: White; padding: 3px">
                                            <%# Server.HtmlDecode(Eval("html").ToString()) %>
                                            <br />
                                        </td>
                                    </tr>
                                </table>
