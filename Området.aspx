<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster1.master" AutoEventWireup="true" CodeFile="Området.aspx.cs" Inherits="Området" %>
...
<table align="center" WIDTH="100%" class="border1">
	<tr>
		<td bgcolor="#efefef">
			<strong>Kortfattad information om området:		
	...
	<tr>
		<td>
		<p>
		Bostadsrättsföreningen Valdemar, är ett <a href="fordonstrafik.aspx"><b>bilfritt</b></a> område 
	    ...
	    <p>Området är byggt 1989/90 och består av 129 <a href="LagenhetFakta.aspx" >marklägenheter.</a> Till
    		varje lägenhet finns det en liten trädgård och ett litet kallförråd. Trädgården sköter lägenhetsinnehavaren själv om. <br>Varje lägenhet har ett eget grovkök med tvättmaskin 		och torkskåp.  &nbsp;&nbsp;  <br><br>
